...
No Alpine variant is provided — uv does not yet publish musl Python distributions (astral-sh/uv#6890).
...
| Tag | Description |
|-----|-------------|
| `python:latest` | Most recent Python version on Debian |
| `python:debian` | Most recent Python version on Debian |
| `python:<major>` | Major-version alias, e.g. `python:3` |
| `python:<major.minor>` | Minor-version alias, e.g. `python:3.13` |
| `python:<major>-debian` | Major alias on Debian, e.g. `python:3-debian` |
| `python:<major.minor>-debian` | Minor alias on Debian, e.g. `python:3.13-debian` |
